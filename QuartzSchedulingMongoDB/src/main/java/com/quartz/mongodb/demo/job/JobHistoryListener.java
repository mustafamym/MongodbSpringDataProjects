package com.quartz.mongodb.demo.job;

import com.quartz.mongodb.demo.repository.JobHistoryRepository;
...
import static com.quartz.mongodb.demo.config.QuartzConfiguration.CONTEXT_KEY;
